...
for quantidade_de_observacoes in p.quantidade_de_observacoes:
    for dimensao in p.dimensoes:
        for expoente in p.expoentes_fuzzy:
            nome_pasta: str = f"resultados/obs_{quantidade_de_observacoes}/experimento_dimensao_{dimensao}_expoente_fuzzy_{expoente}/"
            ...
            nome_arquivo: str = f"experimento_dimensao_{dimensao}_expoente_fuzzy_{expoente}.csv"
            df.to_csv(
...
if __name__ == "__main__":
    ...
    for obs in p.quantidade_de_observacoes:
        for dimensao in p.dimensoes:
            for expoente in p.expoentes_fuzzy:
                caminho_arquivo = f"resultado_agregado/obs_{obs}/experimento_dimensao_{dimensao}_expoente_fuzzy_{expoente}.csv"
